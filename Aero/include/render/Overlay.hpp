...
public:
	...
	///-------------------------------------------------------------------------------------------------
	/// Checks target window size to see if it has moved. Returns true if it has.
	///
	/// @author Tormund
	/// @date   12.11.2019
	///-------------------------------------------------------------------------------------------------
	virtual bool            target_moved();

	///-------------------------------------------------------------------------------------------------
	/// Checks target window size to see if it is available for overlay.
	///
	/// @author Tormund
	/// @date   5.20.2020
	///-------------------------------------------------------------------------------------------------
	virtual bool            target_available();
